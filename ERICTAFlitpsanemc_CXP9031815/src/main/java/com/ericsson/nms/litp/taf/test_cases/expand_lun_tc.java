...
public class expand_lun_tc extends PtafTestRunner implements TestCase {

	// Location of the python test scripts 
	private String scriptsDirectory = "psl_expand_lun";
	
	//Specify the csv data file to use
	//test_id represents the script name and vargs any arguments you wish to pass
	@DataDriven(name = "expand_lun_test_scripts")
	@Test
