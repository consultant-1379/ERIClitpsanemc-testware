...
public class TestRunner4 extends PtafTestRunner implements TestCase {

	// Location of the python test scripts
	private String scriptsDirectory = "psl_delete_snap";
	
	//Specify the csv data file to use
	//test_id represents the script name and vargs any arguments you wish to pass
	@DataDriven(name = "delete_snapshots_test_scripts")
	@Test
