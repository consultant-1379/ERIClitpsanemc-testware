...
public class TestRunner5 extends PtafTestRunner implements TestCase {

	// Location of the python test scripts
	private String scriptsDirectory = "cli_create_snap";
	
	//Specify the csv data file to use
	//test_id represents the script name and vargs any arguments you wish to pass
	@DataDriven(name = "create_snapshots_sancli_test_scripts")
	@Test
